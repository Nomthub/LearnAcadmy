...
/**
 * Servlet implementation class UpdateClassN
 */
@WebServlet("/UpdateClassN")
public class UpdateClassN extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			PreparedStatement ps = con.prepareStatement("update class set ClssName=? where Cid=?");
